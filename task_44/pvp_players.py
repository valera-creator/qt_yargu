...
class PvpPlayers(QWidget):
    ...
    def view_num(self, btn, num):
        """
        метод меняет текст на кнопке и показывает/скрывает введенное число игрока,
        на стороне которого была нажата кнопка
        """
    ...
    def btn_signal(self):
        """
        подготовка виджетов и содержимого виджетов к игре
